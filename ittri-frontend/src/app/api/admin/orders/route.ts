...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const qs = url.search; // keep page, limit, status, store_id, seller_id
    const upstreamUrl = backendUrl(`/admin/orders${qs}`);
    ...
    // impersonation support: forward as header
    ...
    res.headers.set("x-which-route", "admin-orders");
